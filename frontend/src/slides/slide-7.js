        ...
        <div class="relative w-full h-full">
            <div class="absolute inset-0 flex items-center justify-center z-10">
                <div class="text-center">
                    <div class="text-8xl font-mono font-bold text-primary mb-6 border-4 border-primary px-12 py-6 inline-block">&lt;03/&gt;</div>
                    <h1 class="text-4xl font-bold text-white mb-4">第三章</h1>
                    <p class="text-xl text-primary">核心特性</p>
